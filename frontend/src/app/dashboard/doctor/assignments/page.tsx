...
export default function DoctorAssignmentsWorkspace() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto animate-fade-in">
      <div>
        <h2 className="text-xl font-bold text-text-primary">Assignments Manager</h2>
        <p className="text-xs text-text-secondary mt-1">Select one of your taught courses to post assignments, evaluate homework uploads, and approve TA grading.</p>
      </div>
          ...
          {courses.map((course: any) => (
            ...
            >
              <div>
                ...
                <p className="text-[11px] text-text-secondary mt-1">Assignments: {course._count?.assignments || 0}</p>
              </div>
