...
export default function DoctorQuizzesWorkspace() {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto animate-fade-in">
      <div>
        <h2 className="text-xl font-bold text-text-primary">Quizzes Builder</h2>
        <p className="text-xs text-text-secondary mt-1">Select one of your taught courses to construct examinations, grade essay responses, and view student anti-cheat logs.</p>
      </div>
